...
export const fastlistExample1 = `const debug = require("@vectarine/debug")
...
export const fastlistTimedNested = `const debug = require("@vectarine/debug")
...
export const fastlistObjectsFast = `const fastlist = require("@vectarine/fastlist")
const vec = require("@vectarine/vec")
...
export const fastlistVelocityFlipping = `    const vec = require("@vectarine/vec")
...
const vec = require("@vectarine/vec")
const fastlist = require("@vectarine/fastlist")
