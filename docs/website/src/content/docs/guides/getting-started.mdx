...
```powershell
irm https://vectarineengine.com/install_nt.sh | iex
```
</TabItem>
<TabItem label="Linux">
```bash
curl -fsSL https://vectarineengine.com/install_linux.sh | sh
```
</TabItem>
<TabItem label="Mac">
```bash
curl -fsSL https://vectarineengine.com/install_mac.sh | sh
```
</TabItem>
</Tabs>
