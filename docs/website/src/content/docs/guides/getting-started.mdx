...
export const startedEmptyGame = `local Debug = require('@vectarine/debug')
...
export const startedDebugPrint = `local Debug = require("@vectarine/debug")
...
export const startedIoInput = `local Io = require("@vectarine/io")
local Graphics = require("@vectarine/graphics")
local Vec4 = require("@vectarine/vec4")
local Vec = require("@vectarine/vec")
...
export const startedDrawBall = `local Debug = require("@vectarine/debug")
local Graphics = require("@vectarine/graphics")
local Vec4 = require("@vectarine/vec4")
local Vec = require("@vectarine/vec")
...
export const startedMoveBall = `local Debug = require("@vectarine/debug")
local Graphics = require("@vectarine/graphics")
local Vec4 = require("@vectarine/vec4")
local Vec = require("@vectarine/vec")
...
export const startedPersistBall = `local Persist = require("@vectarine/persist")
...
export const startedPlayerInput = `local Graphics = require("@vectarine/graphics")
local Vec4 = require("@vectarine/vec4")
local Vec = require("@vectarine/vec")
...
export const startedOpponent = `local Graphics = require("@vectarine/graphics")
local Vec4 = require("@vectarine/vec4")
local Vec = require("@vectarine/vec")
local Io = require("@vectarine/io")
local Persist = require("@vectarine/persist")
...
export const startedCollision = `local Graphics = require("@vectarine/graphics")
local Vec4 = require("@vectarine/vec4")
local Vec = require("@vectarine/vec")
local Io = require("@vectarine/io")
local Persist = require("@vectarine/persist")
...
-- Ball initialization code stays the same
...
export const startedRandomScore = `local Graphics = require("@vectarine/graphics")
local Vec4 = require("@vectarine/vec4")
local Vec = require("@vectarine/vec")
local Io = require("@vectarine/io")
local Persist = require("@vectarine/persist")
...
export const startedFinalVersion = `local Graphics = require("@vectarine/graphics")
local Vec4 = require("@vectarine/vec4")
local Vec = require("@vectarine/vec")
local Io = require("@vectarine/io")
local Persist = require("@vectarine/persist")
