...
export const tilesetXmlExample = `<?xml version="1.0" encoding="UTF-8"?>
...
<Code lang="xml" code={tilesetXmlExample} title="tileset.tsx" />
...
export const tilemapExample1 = `const graphics = require("@vectarine/graphics")
...
<Code lang="luau" title="scripts/main.luau" code={tilemapExample1} />
...
export const tilemapExample2 = `const graphics = require("@vectarine/graphics")
const loader = require("@vectarine/loader")
const vec = require("@vectarine/vec")
...
<Code lang="luau" title="scripts/level.luau" code={tilemapExample2} />

Because by default the coordinate system increases to the right and up, when creating your level in Tiled, try setting the tile render order to "right-up".
You can also just draw the tiles with a negative scale on the y axis to flip them vertically.
